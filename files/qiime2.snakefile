...
rule all:
    input:
        ...
        f"{OUTPUT_DIR}/core-metrics-results/observed_otus_vector.qza",
...
rule export_alpha_metrics:
    input:
        ...
        observed=f"{OUTPUT_DIR}/core-metrics-results/observed_otus_vector.qza",
    ...
    shell:
        ...
        "qiime tools extract --input-path {input.observed} --output-path {output} && "
